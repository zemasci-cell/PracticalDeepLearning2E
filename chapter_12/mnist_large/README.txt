Source code for the fully convolutional experiments in Chapter 12
-----------------------------------------------------------------
...
1. make_shifted_mnist_dataset.py (makes the augmented datasets)
2. mnist_cnn_aug.py (makes 'mnist_cnn_base_aug_model.h5')
3. mnist_cnn_aug_fcn.py (makes 'mnist_cnn_aug_fcn_model.h5')
4. mnist_cnn_aug_fcn_test.py (tests single images & large images, 'results_aug')
5. mnist_cnn_aug_fcn_heatmaps.py (creates 'heatmaps_aug')
