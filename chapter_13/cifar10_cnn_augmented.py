...
# cifar10_cnn_augmented.py:  0.7480999827384949
...
print("cifar10_cnn_augmented.py: ", score[1])
model.save("cifar10_cnn_augmented_model.keras")
pickle.dump(history, open("cifar10_cnn_augmented_history.pkl","wb"))
pred = model.predict(x_test)
np.save("cifar10_cnn_augmented_predictions.npy", pred)
