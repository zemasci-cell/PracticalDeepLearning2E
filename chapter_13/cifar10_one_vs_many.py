...
def main():
    ...
    #  Load the models
    mm = load_model("bmult/cifar10_cnn_all_model.keras")
    m = []
    for i in range(10):
        m.append(load_model("bmult/cifar10_cnn_%d_model.keras" % i))
    ...
    np.save("bmult/cifar10_multiclass_conf_mat.npy", cm)
    np.save("bmult/cifar10_binary_conf_mat.npy", cb)
