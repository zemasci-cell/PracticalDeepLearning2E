#
#  file:  fmnist_conditional_gan.py
#
#  A CNN-based conditional GAN for FMNIST
#
################################################################
...
if (len(sys.argv) == 1):
    print()
    print("fmnist_conditional_gan.py <latent> <batch_size> <minibatches> <outdir>")
    print()
...
#  Load the all FMNIST training data, scale [0,1]
num_classes = 10
(xtrn, ytrn), (xtst, ytst) = keras.datasets.fashion_mnist.load_data()
xtrn = np.vstack((xtrn, xtst))
xtrn = xtrn / 255
ytrn = np.hstack((ytrn, ytst))
