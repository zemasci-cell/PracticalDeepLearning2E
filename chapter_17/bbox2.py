...
if (len(sys.argv) == 1):
    print()
    print("bbox2 <batch> <epochs> blank|land <outdir>")
    print()
...
#  Load the datasets
if (mode == 'land'):
    xtrain = np.load("../data/mnist/mnist_bbox_land_xtrain.npy") / 255.0
    xtest = np.load("../data/mnist/mnist_bbox_land_xtest.npy") / 255.0
else:
    xtrain = np.load("../data/mnist/mnist_bbox_xtrain.npy") / 255.0
    xtest = np.load("../data/mnist/mnist_bbox_xtest.npy") / 255.0

ytrainc = np.load("../data/mnist/mnist_bbox_ytrainc.npy")
ytrainb = np.load("../data/mnist/mnist_bbox_ytrainb.npy")
